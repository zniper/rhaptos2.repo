...
(function() {
  ...
  define(['underscore', 'backbone', 'jquery', './languages', 'hbs!app/views/content-list', 'hbs!app/views/content-list-item', 'hbs!app/views/modal-wrapper', 'hbs!app/views/edit-metadata', 'hbs!app/views/edit-roles', 'hbs!app/views/language-variants', 'bootstrap', 'select2', 'backbone.marionette'], function(_, Backbone, jQuery, Languages, SEARCH_RESULT, SEARCH_RESULT_ITEM, MODAL_WRAPPER, EDIT_METADATA, EDIT_ROLES, LANGUAGE_VARIANTS) {
    ...
    ContentEditView = Backbone.Marionette.ItemView.extend({
      template: function(serialized_model) {
        return "<div class='edit'>" + (serialized_model.body || 'This module is empty. Please change it') + "</div>";
      },
      initialize: function() {
        var _this = this;
