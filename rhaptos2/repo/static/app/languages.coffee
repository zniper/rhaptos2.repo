...
define [], ->
  ...
  exports.getNativeLanguageNames = ->
    native_languages = {}
  ...
  exports.getCombinedLanguageNames = ->
    combined_languages = {}
  ...
  #
  # 'langcode-variation' : {native : 'Native name', english : 'English name'}
  #
  # The current structure is to have language codes following ISO639-1
  #

  LANGUAGES = {
  'aa' : {'native' : 'магIарул мацI', 'english' : 'Afar',},
  'ab' : {'native' : 'бызшәа', 'english' : 'Abkhazian',},
  'af' : {'native' : 'Afrikaans', 'english' : 'Afrikaans',},
  'am' : {'native' : 'አማርኛ', 'english' : 'Amharic',},
  'ar' : {'native' : 'العربية', 'english' : 'Arabic',},
  'as' : {'native' : 'অসমিয়া', 'english' : 'Assamese'},
  'ay' : {'native' : 'Aymara', 'english' : 'Aymara',},
  'az' : {'native' : 'Azəri Türkçəsi', 'english' : 'Azerbaijani',},
  'ba' : {'native' : 'Bashkir', 'english' : 'Bashkir'},
  'be' : {'native' : 'Беларускі', 'english' : 'Belarussian',},
  ...
  'dz' : {'native' : 'རྫོང་ཁ', 'english' : 'Bhutani',},
  ...
  'hy' : {'native' : 'Հայերէն', 'english' : 'Armenian',},
  ...
  'kk' : {'native' : 'ﻗﺎﺯﺍﻗﺸﺎ', 'english' : 'Kazakh',},
  'kl' : {'native' : 'Greenlandic', 'english' : 'Greenlandic',},
  'km' : {'native' : 'ខ្មែរ', 'english' : 'Cambodian/Khmer',},
  'kn' : {'native' : 'ಕನ್ನಡ', 'english' : 'Kannada',},
  'ko' : {'native' : '한국어', 'english' : 'Korean',},
  'ks' : {'native' : 'काऽशुर', 'english' : 'Kashmiri',},
  ...
  'lb' : {'native' : 'Lëtzebuergesch', 'english' : 'Luxemburgish',},
  'li' : {'native' : 'Limburgs', 'english' : 'Limburgish'},
  'ln' : {'native' : 'Lingala', 'english' : 'Lingala'},
  'lo' : {'native' : 'ພາສາລາວ', 'english' : 'Laotian',},
  'lt' : {'native' : 'Lietuviskai', 'english' : 'Lithuanian',},
  'lv' : {'native' : 'Latviešu', 'english' : 'Latvian'},
  'mg' : {'native' : 'Malagasy', 'english' : 'Madagascarian',},
  ...
  'oc' : {'native' : 'Languedoc', 'english' : 'Occitan',},
  ...
  'so' : {'native' : 'Somali', 'english' : 'Somali',},
  ...
  'uz' : {'native' : 'Ўзбекча', 'english' : 'Uzbek',},
  ...
  'yi' : {'native' : 'ײִדיש', 'english' : 'Yiddish',},
  ...
  'zh-cn' : {'english' : 'Chinese (China)', 'native' : '简体中文(中国)', },
  'zh-hk' : {'english' : 'Chinese (Hongkong)', 'native' : '繁體中文(香港)', },
  'zh-sg' : {'english' : 'Chinese (Singapore)', 'native' : '简体中文(新加坡)', },
  'zh-tw' : {'english' : 'Chinese (Taiwan)', 'native' : '繁體中文(臺灣)', }
  }
