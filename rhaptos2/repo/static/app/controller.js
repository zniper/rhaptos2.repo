...
(function() {
  ...
  define(['jquery', 'backbone', 'marionette', 'app/models', 'app/views', 'hbs!app/layout-content', 'exports', 'i18n!app/nls/strings'], function(jQuery, Backbone, Marionette, Models, Views, LAYOUT_CONTENT, exports, __) {
    var $main, $originalContents, ContentLayout, ContentRouter, contentLayout, mainController, mainRegion;
    $main = jQuery('#main');
